<x-web-layout :title="$title">
    {{-- silder start --}}
    <div class="swiper-container dots-over" data-margin="5" data-dots="true" data-nav="true" data-autoplay="true" data-autoheight="true">
        <div class="swiper">
                    ...
                    <div class="overlap-grid overlap-grid-2">
                        <div class="item">
                            <figure class="rounded shadow">
                                <img src="{{ asset('/storage/uploads/' . $setting['section_1_image']['value']) }}" srcset="{{ asset('/storage/uploads/' . $setting['section_1_image']['value']) }} 2x" alt="">
                            </figure>
                        </div>
                        <div class="item">
                            <figure class="rounded shadow">
                                <iframe class="rounded" style="width: 530px; max-width:100%" height="300px" src="{{ $setting['section_1_url_video']['value'] }}" title="" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                            </figure>
                        </div>
                    </div>
                </div>
    ...
    <section class="wrapper bg-light">
        <div class="container pb-14 pb-md-16">
            <div class="card rounded-4" style="background-image: url('{{ asset('/storage/uploads/' . $setting['section_2_image']['value']) }}'); background-size: cover; background-position: center; background-repeat: no-repeat;">
                <div class="card-body px-xl-15 pb-0">
                    <div class="row gx-lg-8 gx-xl-0 align-items-center">
                        ...
                        <div class="col-lg-6 text-center text-lg-start" data-cues="slideInDown" data-group="page-title" data-delay="600">
                            <h2 class="display-5 mb-5 text-light">{{ $setting['section_2_title']['value'] }}</h2>
        ...
        <div class="container pb-14 pb-md-16 text-center">
            <div class="row">
                <div class="col-md-9 col-lg-8 col-xl-8 mx-auto text-center">
                    <img src="{{ asset('') }}web-assets/img/icons/lineal/puzzle-2.svg" class="svg-inject icon-svg icon-svg-md mb-4" alt="" />
            ...
            <img src="{{ asset('/storage/uploads/' . $setting['section_3_image']['value']) }}" class="rounded" alt="" style="width: 100%;">
            <!-- /.row -->
        </div>
        <!-- /.container -->
    </section>
    ...
    {{-- sectio 4 start --}}
    <section class="wrapper image-wrapper bg-image bg-overlay text-white" data-image-src="{{ asset('/storage/uploads/' . $setting['section_4_image']['value']) }}" style="background-image: url('{{ asset('/storage/uploads/' . $setting['section_4_image']['value']) }}');">
            ...
            <div class="row gx-xl-12 gy-10">
                ...
                <div class="col-xl-8">
                    <div class="position-relative">
                        <div class="shape rounded-circle bg-soft-primary rellax w-16 h-16" data-rellax-speed="1" style="top: -0.7rem; right: -1.7rem;"></div>
                        <div class="shape rounded-circle bg-line primary rellax w-16 h-16" data-rellax-speed="1" style="bottom: -0.5rem; left: -1.4rem;"></div>
                                                    ...
                                                    <div class="card-body">
                                                        <blockquote class="icon mb-0">
                                                            ...
                                                            <div class="blockquote-details">
                                                                <img class="rounded-circle w-12" src="{{ asset('/storage/uploads/' . $alumni['image']) }}" srcset="{{ asset('/storage/uploads/' . $alumni['image']) }} 2x" alt="" />
                                                                <div class="info">
                ...
                <div class="swiper">
                    <div class="swiper-wrapper">
                        @foreach ($news as $berita)
                            <div class="swiper-slide">
                                <article>
                                    <figure class="overlay overlay-1 hover-scale rounded mb-5"><a href="{{ route('news_detail', $berita->slug) }}"> <img src="{{ asset('/storage/uploads/' . $berita->thumbnail) }}" alt="" /></a>
                                        <figcaption>
                                    ...
                                    <div class="post-header">
                                        <div class="post-category text-line">
                                            <a href="#" class="hover" rel="category">{{ $berita->bidang->nama_bidang }}</a>
                                        </div>
                                        <!-- /.post-category -->
                                        <h2 class="post-title h3 mt-0 mb-0"><a class="link-dark" href="{{ route('news_detail', $berita->slug) }}">{{ $berita->title }}</a>
                                        </h2>
                                    </div>
                                    <!-- /.post-header -->
                                    <div class="post-footer">
                                        <ul class="post-meta">
                                            <li class="post-date"><i class="uil uil-calendar-alt"></i><span>{{ tanggal($berita->created_at) }}</span>
                                            </li>
                                        </ul>
                                        <!-- /.post-meta -->
                                    </div>
