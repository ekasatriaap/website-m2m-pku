...
class SettingBerandaWebRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            "section_1_image" => "image|mimes:jpeg,png,jpg,gif,svg|max:2048",
            ...
            "section_2_image" => "image|mimes:jpeg,png,jpg,gif,svg|max:2048",
            "section_2_foto" => "image|mimes:jpeg,png,jpg,gif,svg|max:2048",
            "setting.section_3_title" => "required|string|max:255",
            "setting.section_3_description" => "required|string",
            "section_3_image" => "image|mimes:jpeg,png,jpg,gif,svg|max:2048",
            "setting.section_4_title" => "required|string|max:255",
            "setting.section_4_description" => "required|string",
            "section_4_image" => "image|mimes:jpeg,png,jpg,gif,svg|max:2048",
        ];
    }
